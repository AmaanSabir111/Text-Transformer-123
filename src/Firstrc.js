...
export default function Firstrc(props) {
  ...
  return (
    ...
    <div className="container-fluid" >
      <Link style={{fontWeight:"bolder",fontSize:"1.3rem"}} className="navbar-brand" to="/">{props.brand}</Link>
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          <li className="nav-item">
            <Link onClick={()=>{click("/")}} className="nav-link" style={{fontWeight:bold==="/"?"bolder":"lighter"}} aria-current="page" to="/">Home</Link>
          </li>
           <li className="nav-item">
            <Link style={{fontWeight:bold==="/a"?"bolder":"lighter"}} onClick={()=>{click("/a")}} className="nav-link" to="/a">{props.about}</Link>
          </li>
          {/* <li className="nav-item">
